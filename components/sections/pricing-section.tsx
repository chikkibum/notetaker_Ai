      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-white/80">{pricing.badge.text}</span>
          </motion.div>
          ...
          {pricing.plans.map((plan, index) => (
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={`w-full py-3 px-6 text-base rounded-lg font-medium transition-all duration-200 ${
                  plan.popular
        ...
        >
          <p className="text-white/60  text-base">{pricing.bottomCta.text}</p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="text-[#e78a53] hover:text-[#e78a53]/80 text-lg font-medium transition-colors"
          >
